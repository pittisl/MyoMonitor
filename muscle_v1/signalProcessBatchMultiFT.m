% This is to process the received data IN FOLDER  %%%% This should process
% the data with MULTIPLE FEATURES
% THIS IS THE COPY OF signalProcessBatch.m
function fatigueValues = signalProcessBatchMultiFT()
% Parameters
...
%% plot
fatigueValues_G1_1 = fatigueValues(1,:);
fatigueValues_G1_2 = fatigueValues(2,:);
